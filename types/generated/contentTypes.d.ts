...
export interface ApiCoursesPageeCoursesPagee extends Schema.SingleType {
  ...
  attributes: {
    title: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'Our Coursese'>;
    slug: Attribute.UID<'api::courses-pagee.courses-pagee', 'title'> &
      Attribute.Required;
    pageInfo: Attribute.Component<'layout.page-info'>;
    excludedCourses: Attribute.Relation<
      'api::courses-pagee.courses-pagee',
      'oneToMany',
      'api::course.course'
    >;
    createdAt: Attribute.DateTime;
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    ...
    dynamicHomeSection: Attribute.DynamicZone<
      ['layout.news-letter-form', 'layout.mission']
    >;
...
export interface ApiPostPost extends Schema.CollectionType {
  ...
  attributes: {
    ...
    author: Attribute.Relation<'api::post.post', 'oneToMany', 'admin::user'>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::courses-pagee.courses-pagee': ApiCoursesPageeCoursesPagee;
